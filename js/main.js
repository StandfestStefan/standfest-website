...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- 13a. Footer-Adresse (sichtbares NAP, Werte aus impressum.html) ---
  if (footerBrand && !footerBrand.querySelector('.footer-address')) {
    const addressHTML =
      '<address class="footer-address">' +
        'Kaiser-Franz-Josef-Straße 3<br>2114 Großrussbach, Österreich' +
      '</address>';
    footerBrand.insertAdjacentHTML('beforeend', addressHTML);
  }
